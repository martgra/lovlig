...
lint:
	uv run ruff check lovlig tests

format:
	uv run ruff format lovlig tests

run:
	uv run python lovlig/__main__.py

secrets: .secrets.baseline  # pragma: allowlist secret
...
github-create: .check-gh
	...
	@echo "🚀 Creating GitHub repository martgra/lovlig..."
	@gh repo create martgra/lovlig --public --source=. --remote=origin
	@echo "✅ Repository created at: https://github.com/martgra/lovlig"
	@echo ""
...
github-push: .check-gh
	...
	@echo "🔗 View at: https://github.com/martgra/lovlig"
